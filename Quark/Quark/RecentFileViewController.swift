//
//  RecentFileViewController.swift
//  Quark
//
...
class RecentFileViewController: UIViewController {
    ...
    func setUpNavigationBar(){
        ...
        let saveButton = UIBarButtonItem(title: "Open", style: .plain, target: self, action: #selector(showTextView))
